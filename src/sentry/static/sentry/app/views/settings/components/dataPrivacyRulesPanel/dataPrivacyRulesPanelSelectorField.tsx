...
class DataPrivacyRulesPanelSelectorField extends React.Component<Props, State> {
  ...
  getAllSuggestions() {
    return [...this.getValueSuggestions(), ...unaryOperatorSuggestions, ...binaryOperatorSuggestions];
  }
  ...
  loadFieldValues = (newValue: string, initialLoading = false) => {
    ...
    const {showSuggestions = true, filteredSuggestions} = this.getNewSuggestions(fieldValues);
